...
We have modified branches 6.1 and 6.6 to allow testing of NuoDB's Hibernate 6 dialect.
...
. The tests do not clean up properly and leak connections.
...
*** _15029 tests completed, 4 failed, 2294 skipped_ (NuoDB V7.0.0)
