...
/**
 * NUODB: Copy of this class from hibernate-testing to reduce test timeout from 30 - 3 mins.
 *
...
public abstract class BaseUnitTestCase {
	...
	private static boolean enableConnectionLeakDetection = Boolean.TRUE.toString()
			.equalsIgnoreCase( System.getenv( "HIBERNATE_CONNECTION_LEAK_DETECTION" ) );
